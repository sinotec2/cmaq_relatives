...
#> is located by default).
 ...
 set BLD       = /opt/CMAQ_Project/CCTM/scripts/BLD_CCTM_${VRSN}_${compilerString}
...
# =====================================================================
  ...
  setenv N_EMIS_GR 1
  set EMISfile  = area_${GRID_NAME}.${APYM}.nc
...
#  set STKCASEE = 10   # 12US1_cmaq_cb6_2016ff_16j  # Stack Emission Version Label
  ...
  setenv STK_EMIS_001 $IN_PTpath/${STKCASEG}${STKCASEE}.${APYM}.timvar.nc
